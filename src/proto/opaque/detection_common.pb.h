...
typedef enum _ser_DetectionStatus
{
  ...
  ser_DetectionStatus_DETECTION_STATUS_NOT_READY
  = 2, /* Engine/IPC not initialized */
  ser_DetectionStatus_DETECTION_STATUS_IPC_TIMEOUT
  = 3, /* No frame within timeout */
  ser_DetectionStatus_DETECTION_STATUS_INFER_FAILED
  = 4,                                           /* Inference engine error */
  ser_DetectionStatus_DETECTION_STATUS_ERROR = 5 /* Unclassified error */
} ser_DetectionStatus;

/* Struct definitions */
/* Single object detection result (detector-agnostic).
 Bounding box uses NDC coordinates: -1.0 (left/top) to 1.0 (right/bottom),
 center is (0,0). Consistent with JonGuiDataROI pattern. */
...
#define _ser_DetectionStatus_MIN \
  ser_DetectionStatus_DETECTION_STATUS_UNSPECIFIED
#define _ser_DetectionStatus_MAX ser_DetectionStatus_DETECTION_STATUS_ERROR
#define _ser_DetectionStatus_ARRAYSIZE \
  ((ser_DetectionStatus)(ser_DetectionStatus_DETECTION_STATUS_ERROR + 1))
