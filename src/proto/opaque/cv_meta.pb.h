...
/* Struct definitions */
/* Per-channel CUDA IPC metadata (frame timing + sharpness pyramid + sensor
 gain). Populated from /jon_cuda_ipc_day and /jon_cuda_ipc_heat shared memory.
 */
...
#define ser_CvChannelMeta_init_default                                         \
  { 0, 0, 0, 0, { { NULL }, NULL }, { { NULL }, NULL }, { { NULL }, NULL }, 0, \
    0, 0, 0, 0 }
#define ser_CvMeta_init_default                   \
  { 0,     0,                                     \
    ...
    false, ser_CvChannelMeta_init_default,        \
    false, ser_CvChannelMeta_init_default }
#define ser_CvChannelMeta_init_zero                                            \
  { 0, 0, 0, 0, { { NULL }, NULL }, { { NULL }, NULL }, { { NULL }, NULL }, 0, \
    0, 0, 0, 0 }
#define ser_CvMeta_init_zero                   \
  { 0,     0,                                  \
    false, ser_JonGuiDataCameraDay_init_zero,  \
    false, ser_JonGuiDataCameraHeat_init_zero, \
    false, ser_JonGuiDataRotary_init_zero,     \
    false, ser_CvChannelMeta_init_zero,        \
    false, ser_CvChannelMeta_init_zero }
